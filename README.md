...
- Управление источником звука по умолчанию, независимым автовоспроизведением текущего источника при загрузке, онлайн-плеером по умолчанию и его автосворачиванием;

...
- Atlas Media API (`com.mmwtl.atlasmediaapi`) с поддержкой Media Bridge `protocol v1`;
...
масштаб интерфейса и автозапуск. Системные разрешения и текущее состояние сервиса в резервную копию не входят.

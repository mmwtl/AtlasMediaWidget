...
Когда активно Радио, кнопка `♥` открывает внутри карточки список лайкнутых станций. Режим прямого
...
масштаб интерфейса, режим навигации по сохранённым радиостанциям и автозапуск. Системные

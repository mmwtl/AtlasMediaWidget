...
Все четыре клиентских пункта реализованы в версии `1.0.1 (2)`. Проверки firmware-specific частей
...
`1.0.1[2]AtlasMediaWidget`. Без локального `secure.signing.gradle` release APK остаётся unsigned.

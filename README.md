...
Все четыре клиентских пункта реализованы в версии `1.0.11 (12)`. Проверки firmware-specific частей
...
`1.0.11[12]AtlasMediaWidget`. Без локального `secure.signing.gradle` release APK остаётся unsigned.

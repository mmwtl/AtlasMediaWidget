...
- список лайкнутых радиостанций с обложками и прямым переключением внутри карточки;
...
масштаб интерфейса, режим навигации по сохранённым радиостанциям, видимость точек перемещения и
автозапуск. Системные

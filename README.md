...
2. Откройте приложение и выдайте разрешения поверх окон, на историю использования и на контроль окон.
3. В `integrated` откройте отдельный ярлык «Atlas Media API» либо «Настройки медиасервиса» внутри
   Widget и выдайте доступ к уведомлениям и хранилищу.

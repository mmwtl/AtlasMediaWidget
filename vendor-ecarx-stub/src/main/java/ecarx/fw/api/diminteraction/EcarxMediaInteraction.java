...
public interface EcarxMediaInteraction {
    void setMediaInteractionCallback(EcarxMediaInteractionCallback callback);

    void unsetMediaInteractionCallback(EcarxMediaInteractionCallback callback);
    ...
    void updatePlaybackInfo(EcarxPlaybackInfo playbackInfo);

    void updatePlaylist(int sourceType, List<?> list);
